...
// Unstructured-session body-region S-codes resolve to English region labels.
assert.equal(resolveExerciseName("S4209"), "Shoulders");
assert.equal(resolveExerciseName("S4214"), "Legs & Hips");
assert.equal(resolveExerciseName("S4208"), "Full Body");
