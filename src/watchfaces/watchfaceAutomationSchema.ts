...
const WATCHFACE_SCHEMA_DEFINITIONS = {
  ...
  modeDesign: { type: "object", additionalProperties: false, properties: {
    ...
    metricChanges: { type: "object", additionalProperties: { type: "boolean" } }, metricStyles: { type: "object", additionalProperties: { $ref: "#/$defs/typography" } }, kcalProgress: { $ref: "#/$defs/kcalProgress" }, exerciseProgress: { $ref: "#/$defs/exerciseProgress" }, exerciseSeparator: { $ref: "#/$defs/exerciseSeparator" }, selectableMetricStyle: { $ref: "#/$defs/typography" }, controlComplicationEnabled: { type: "object", additionalProperties: { type: "boolean" } }, controlBarometerMode: { enum: ["static", "directional"] }, controlIconOffsets: { type: "object", additionalProperties: { $ref: "#/$defs/offset" } }, separateAutoTime: { type: "boolean" }, addSeconds: { type: "boolean" }, timeStyles: { type: "object", additionalProperties: { $ref: "#/$defs/typography" } }, dateStyles: { type: "object", additionalProperties: { $ref: "#/$defs/dateTypography" } }, staticSeparators: { type: "object", additionalProperties: false, required: ["colon", "dateSlash"], properties: { colon: { $ref: "#/$defs/staticSeparator" }, dateSlash: { $ref: "#/$defs/staticSeparator" } } }, ampmIndicator: { $ref: "#/$defs/indicator" }, weatherIndicator: { $ref: "#/$defs/weatherIndicator" }, nativeData: {$ref:"#/$defs/nativeDataMap"}, layoutOffsets: { type: "object", additionalProperties: { $ref: "#/$defs/offset" } },
...
const MODE_KEYS = new Set([
  ...
  "controlBarometerMode", "controlIconOffsets", "separateAutoTime", "addSeconds", "timeStyles", "dateStyles",
...
export function validateWatchfaceAutomationDocument(
  ...
  for (const key of ["artworkVisible", "stripBlankConfigKeys", "tintLabels", "tintIcons", "separateAutoTime", "addSeconds", "controlBatteryEnabled", "controlSunriseEnabled", "controlSunsetEnabled", "controlFloorEnabled", "controlTemperatureEnabled"] as const) if (design[key] !== undefined) bool(design[key], diagnostics, `/design/${key}`);
